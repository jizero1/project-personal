...
import './About.css';
import { FaAdjust, FaBuffer, FaCheck } from "react-icons/fa";

const About = () => {

    return (
        <div className="about common-flex">
            <div className="about-title">
                <h2 className="about-title-h2">ABOUT</h2>
            </div>
            <div className="about-text-container common-flex">
                <div className="about-text-innerContainer about-1">
                    <div className="about-text-iconContainer common-flex">
                    ...
                    <div className="about-img-container common-flex">
                        <img className="about-img" src="./img/personalColor.jpg" alt="퍼스널컬러이미지"></img>
                    </div>
                </div>
                <div className="about-text-innerContainer about-2">
                    ...
                    <hr className="about-text-hr"></hr>
                    <div className="about-color-Container common-flex">
                ...
                <div className="about-text-innerContainer about-3">
                    <div className="about-text-iconContainer common-flex">
                        <FaCheck className="about-text-icon" />
                    </div>
                    ...
                    <hr className="about-text-hr"></hr>
                    <div className="about-img-container common-flex">
                        <img className="about-img about-3-img" src="./img/personalClothes.jpg" alt="퍼스널컬러 의류사진"></img>
                    </div>
                </div>
            </div>
        </div>
